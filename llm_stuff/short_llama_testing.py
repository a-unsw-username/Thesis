...
results = "D:/Users/andrew/uni_work/thesis/code/results/hubertlarge_kenlm/short_cleaned_finetune_CU_20250702_finetuned_result"
...
for index, row in results_df.iterrows():
    ...
    response = ollama.chat(
        ...
        messages=[
            {
                'role': 'system',
                'content': "You are a linguistic expert who is confident in their ability, as such you don't provide explanations to your choices/corrections and you do not add extra formatting to responses"
            },
            {
                'role': 'user',
                'content': prompt
