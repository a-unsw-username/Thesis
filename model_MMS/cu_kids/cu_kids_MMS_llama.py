...
testing_id = "finetune_CU_20250609_lr1e-5"
...
baseline_results_fp = baseline_results_dir + testing_id + '_baseline_result.csv'
print("--> baseline_results_fp:", baseline_results_fp)

baseline_adjusted_results_fp = baseline_results_dir + testing_id + '_baseline_adjusted_result.csv'
...
finetuned_results_fp = finetuned_results_dir + testing_id + '_finetuned_result.csv'
print("--> finetuned_results_fp:", finetuned_results_fp)

finetuned_adjusted_results_fp = finetuned_results_dir + testing_id + '_finetuned_adjusted_result.csv'
